...
import type { ComprobanteArca } from '../services/costosObraService'
...
function Fila({ c, obras }: { c: ComprobanteArca; obras: string[] }) {
...
export function AsignarComprobantes({ comprobantes, obras }: { comprobantes: ComprobanteArca[]; obras: string[] }) {
