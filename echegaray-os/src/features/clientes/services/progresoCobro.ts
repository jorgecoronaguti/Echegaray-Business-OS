...
// LA BARRA MIDE NETO CONTRA NETO (11/09/2026). Hasta hoy acá vivían `IVA_GENERAL = 1.21` y
// `progresoDeCobroBruto`, que llevaban el contrato a bruto para compararlo con el cobro total. Con
// el contrato desglosado (`obra_contrato`) el cobro neto de `obra_cuenta` se compara directo contra
// el contrato neto y la constante del IVA —un supuesto declarado— dejó de hacer falta.
