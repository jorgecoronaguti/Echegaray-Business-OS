...
// Los tests de `resumenDeOrdenes` se fueron con la función el 13/09/2026: sus casos —el tipo como
// lo guarda la base, un PDF sin importe que no suma cero, facturas y retenciones que no son
// órdenes— viven ahora en `registroOrdenes.test.ts`, contra `totalDeOC` y `armarRegistro`.
