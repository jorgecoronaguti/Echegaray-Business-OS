...
const ENLACES_MULTIPLICADOS: { archivo: string; ancla: string; porque: string }[] = [
  ...
  // La fila de la obra ya NO va a `/obras/<id>`: desde el 10/09/2026 abre el detalle DENTRO del
  // CRM («Administración es un CRM y Obra un ERP»), con el mismo `hrefOrdenes` que el panel.
  { archivo: 'features/clientes/components/TablaClientes.tsx', ancla: 'href={hrefOrdenes(o.obra_id)}', porque: 'una obra en ejecución por cliente' },
