...
const MAPA: readonly Entrada[] = [
  ...
  { prefijo: '/campo/material', que: 'el material pedido', cartera: { href: '/campo', texto: 'Trabajo' } },
  ...
  { prefijo: '/herramientas/', que: 'esta pantalla de Herramientas', cartera: { href: '/herramientas', texto: 'Herramientas' } },
  { prefijo: '/herramientas', que: 'el resumen de Herramientas' },
  { prefijo: '/h/', que: 'la herramienta del código', cartera: { href: '/herramientas', texto: 'Herramientas' } },
  ...
  { prefijo: '/campo/parte', que: 'el parte de obra', cartera: { href: '/campo', texto: 'Trabajo' } },
  { prefijo: '/campo/impedimento', que: 'la carga del impedimento', cartera: { href: '/campo', texto: 'Trabajo' } },
  { prefijo: '/campo/herramientas/', que: 'esta pantalla de herramientas', cartera: { href: '/campo/herramientas', texto: 'Herramientas' } },
  { prefijo: '/campo/herramientas', que: 'las herramientas de obra', cartera: { href: '/campo', texto: 'Trabajo' } },
  { prefijo: '/campo', que: 'la pantalla de campo', cartera: { href: '/obra/hoy', texto: 'Hoy' } },
