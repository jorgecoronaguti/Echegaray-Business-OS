...
// TIEMPO REAL (dueño, 15/09/2026). Cartera y ficha de proveedores.
// En el layout y no en cada página: cubre todos los `return` (vacío, error, contenido) y las rutas
// de abajo. No dibuja nada.
export default function ProveedoresEnVivoLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <RefrescarEnVivo tablas={TABLAS_DE.proveedores} />
      {children}
    </>
  )
}
