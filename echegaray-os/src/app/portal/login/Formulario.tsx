...
// «¿Trabajás en Echegaray? Entrá por acá» SE RETIRÓ (dueño, 24/09/2026): el portal no tiene ninguna
// puerta hacia el sistema de gestión. El empleado entra por app.ecsas.com.ar/login como siempre.
