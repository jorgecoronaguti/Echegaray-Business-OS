...
--                 social o alias vinculado). Marcados por el dueño el 14/09/2026: Tello, Fredes, Castro, Angel
--                 Fernandez y Leandro Rojas (dry: orquestador/scripts/proveedores-subcontratistas-dry.mjs).
--
-- La marca por familia_material se RETIRÓ (auditoría 14/09/2026): reclasificaba por texto y tomaba a Corralón
-- Progreso ($47.461,82). Estructura sale en la 0815: acá la invariante es materiales + subcontratos = antes.
--
