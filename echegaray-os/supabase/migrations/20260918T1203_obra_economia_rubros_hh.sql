-- `obra_economia_rubros` publica también las horas hombre cotizadas (18/09/2026).
--
-- Analíticas → Obras compara las horas cargadas contra las que previó la cotización, y ese número
-- (`presupuestos.hh_estimada`, cargado el 17/09 desde Análisis) no estaba en la vista: la pantalla lo
-- leía de `presupuestos` por su cuenta, que es justo la segunda lectura que esta vista vino a evitar.
