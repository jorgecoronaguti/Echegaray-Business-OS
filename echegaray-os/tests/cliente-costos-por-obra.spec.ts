...
for (const cliente of ['quattropani', 'san-francisco'] as const) {
  test(`la tabla de trabajos de ${cliente} publica MATERIALES y MANO DE OBRA, y ni estado ni cobranza`, async ({ page }) => {
    ...
    for (const ancho of ANCHOS) {
      ...
      // «otros» entró el 18/09/2026 con la regla de los cuatro rubros: misma forma, mismo control.
      for (const celda of ['materiales-obra-cliente', 'subcontratos-obra-cliente', 'otros-obra-cliente', 'mano-obra-obra-cliente']) {
