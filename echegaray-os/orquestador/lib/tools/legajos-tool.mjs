  ...
  return {
    'legajos.estado': {
      ...
      schema: {
        name: 'legajos_estado',
        description:
          'Foto de completitud de los LEGAJOS del personal, leída de la carpeta real del data room (ALTAS - BAJAS - HM - EPP - DNI). Dice cuántas personas hay, cuántas activas vs dadas de baja, y qué legajo ACTIVO le falta un documento requerido: ALTA (IERIC) + DNI + HM (examen médico) + EPP (constancia de entrega). El dato clave es la exposición ART/IERIC: activos sin examen médico, sin DNI o sin alta. USALO para "¿cómo están los legajos?", "¿a quién le falta el examen médico?", "¿qué legajos están incompletos?", "¿cuántos empleados tenemos con papeles en orden?". Números REALES de los archivos indexados, 0 inventado. Aclaración: los archivos sueltos se atribuyen por nombre (inferencia) y hay que verificarlos contra el archivo. Sin parámetros.',
