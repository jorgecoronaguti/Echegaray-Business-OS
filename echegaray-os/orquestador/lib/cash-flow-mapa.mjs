...
export const LINEAS = [
  ...
  { fila: 10, concepto: 'Cobranzas esperadas (proyección)', tipo: 'subtotal', hijos: [11, 12, 13] },
  ...
  { fila: 21, concepto: 'ℹ control · nómina de administración según Compras', tipo: 'subtotal', hijos: [22], noSuma: true },
  ...
  { fila: 46, concepto: 'Impuesto al cheque (Ley 25.413)', tipo: 'derivada', criterio: '0,6% de la suma de las filas que mueven la cuenta', calc: null },
  { fila: 47, concepto: 'ℹ control · salió del banco y no está en Compras', tipo: 'subtotal', hijos: [48, 49, 50], noSuma: true },
