...
const data = {
  ...
  '02_Cobranzas!A5:R2000': [
    // A..R (18 cols): idx12=M Total, idx14=O Estado, idx17=R Mes cobro
...
async function main() {
  ...
  check('cobrado del mes (solo jul-26 Cobrado)', b.cobranzas_mes.cobrado === 5000000)
  check('por cobrar del mes (jul-26 no cobrado)', b.cobranzas_mes.por_cobrar === 3000000)
  check('NO cuenta cobranza de otro mes (jun-26)', b.cobranzas_mes.cobrado + b.cobranzas_mes.por_cobrar === 8000000)
