...
export const PROMPT_LECTURA = [
  ...
  'la sigla impresa del proveedor, una abreviatura de obra ("SF", "OB") ni la letra del comprobante. Si no',
  'hay iniciales escritas a mano, poné null en las dos: es la respuesta normal.',
  '',
