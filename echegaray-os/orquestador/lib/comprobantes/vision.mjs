...
export const PROMPT_LECTURA = [
  ...
  '',
  'TRANSCRIBÍ TODO LO MANUSCRITO, NO SÓLO LA OBRA. Va TODO a "anotacion_manuscrita", separado con',
  '" · " y en el orden en que está escrito: la obra o el cliente, el frente, el vehículo o la',
  'patente, el "c/c" o "contado", la forma de pago ("cheque 30 días", "efectivo", "transferencia"),',
  'una fecha escrita a mano, un número de orden de compra, un nombre. Lo que a vos te parezca',
  'irrelevante es lo que después decide a qué obra va el gasto: el 15/09/2026 ocho tickets entraron',
  'sin obra y en todos estaba escrita — "Estrella Filtraciones OFICINA Y FÁB.", "Ford XLS",',
  '"QUATTROPANI", "Messino Dilucion", "SF Pisos Industriales". Recortar la transcripción es perder',
  'el único dato que el papel no trae impreso.',
  '',
  'SI UNA PALABRA NO SE LEE BIEN, PONELA IGUAL Y DECÍ LA ALTERNATIVA. En',
  '"anotacion_manuscrita" va lo que MÁS se parece a lo que ves, letra por letra; en',
  '"anotacion_alternativa" va la otra lectura posible de esa misma tinta ("Messino" / "Messina",',
  '"FÁB." / "FAB"), o null si no dudaste. No elijas vos cuál es la buena y no la "corrijas" a algo',
  'que te suene: las dos viajan y del lado del sistema se resuelven contra el catálogo de obras.',
  '',
  ...
  'poné null.',
  '',
  'LAS INICIALES DE QUIEN PAGÓ. Quien paga un ticket con efectivo de la empresa escribe A MANO sus',
  'INICIALES en el papel: dos a cuatro letras mayúsculas sueltas ("EM", "JP", "J.C.", "RE"), a veces con',
  'puntos o encerradas en un círculo, en cualquier margen. Si las ves, copiá SÓLO LAS LETRAS, sin puntos',
  'ni espacios, en "iniciales_manuscritas", y en "iniciales_confianza" un número de 0 a 1 que diga cuán',
  'seguro estás de CADA letra (0.9 = clarísimas; 0.5 = una de las letras podría ser otra). No son iniciales',
  'nada IMPRESO ("C.F." de Consumidor Final, "IVA", la sigla del proveedor, la letra del comprobante) ni una',
  'abreviatura de obra ("SF", "OB"). Si las copiás, tienen que figurar también en "anotacion_manuscrita". Si',
  'no hay iniciales escritas a mano, poné null en las dos: es la respuesta normal.',
  '',
...
'· El EMISOR es quien VENDE: el proveedor, arriba del todo, con su logo. El comprobante también',
  ...
  '"anotacion_manuscrita":"<TODO lo escrito a mano, tal cual, separado con " · ", o null>",',
  '"anotacion_alternativa":"<la otra lectura posible de esa misma tinta, o null>",',
  '"iniciales_manuscritas":"<2 a 4 letras escritas a mano por quien pagó, o null>",',
  '"iniciales_confianza":<0 a 1, o null>,',
