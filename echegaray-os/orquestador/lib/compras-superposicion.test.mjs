...
import {
  cuentaParaSuperponer, leerLoDecididoEnLaApp, mismoConjunto, repartir, superponerLoDecidido,
...
test('un cambio aplicado durante la lectura del Sheet se superpone igual (antes se perdía hasta el sync siguiente)', () => {
  ...
  const cambio = { id: 'c1', fila: 889, clave: 'c:1|A', tipo: 'obra', estado: 'aplicado', valor_nuevo: 'OB-0007 · LE - GALPÓN 9', creado_at: antes, aplicado_at: despues }
...
test('de dos cambios de obra de la misma fila gana el más nuevo; las filas sin `tipo` (anteriores a la migración) son de obra', () => {
  const r = repartir([
    { id: 'a', fila: 10, estado: 'pendiente', valor_nuevo: 'OB-0001 · x', creado_at: antes },
    { id: 'b', fila: 10, estado: 'pendiente', valor_nuevo: 'OB-0002 · y', creado_at: despues },
    { id: 'c', fila: 11, estado: 'pendiente', valor_nuevo: 'OB-0003 · z', creado_at: antes, tipo: null },
  ], DESDE)
