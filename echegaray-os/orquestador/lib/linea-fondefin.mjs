...
export const CONDICION_FONDEFIN = {
  ...
  observaciones: [
    ...
    'TOPE REAL: los $150.000.000 son el techo del reglamento, NO una línea aprobada. Para responsable inscripto el monto se determina por el promedio de ventas netas de las últimas "6 o 12 declaraciones juradas de IVA ante ARCA, SEGÚN LA ACTIVIDAD QUE DESARROLLE" (textual: el ROP no dice cuál corresponde a la construcción — la ventana la elige la Fiduciaria y cambia el resultado), se estima un margen de utilidad del 40% sobre ese promedio, y la CUOTA mensual no puede superar el 35% de ese margen, restando los compromisos financieros ya informados en el sistema crediticio. El monto que Echegaray puede pedir sale de esa cuenta, no del tope.',
  ...
  preguntar: [
    ...
    '¿Para una constructora toman las últimas 6 o las últimas 12 DDJJ de IVA? El ROP dice "6 o 12 según la actividad" y no aclara cuál — la ventana cambia el monto máximo. ¿Cuánto da con la cuota topeada al 35% del margen estimado?',
    '¿Cuánta cobertura de garantía exigen si se combina prenda con otra, y qué porcentaje pide la hipoteca cuando NO es la única garantía? El ROP sólo publica el 150% para el caso de hipoteca única.',
