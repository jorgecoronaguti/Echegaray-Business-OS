...
//
// «Fredes y Castro, Angel Fernandez (montajes) y Leandro Rojas. FEMENIA NO.» El rubro vive en
...
export const CONFIRMADOS = Object.freeze(['Pedro Fredes', 'Gerson Castro', 'Angel Fernandez', 'Leandro Rojas'])
