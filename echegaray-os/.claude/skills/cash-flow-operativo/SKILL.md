...
description: "Aplicar reglas de negocio del Flujo de Caja de Echegaray Construcciones al diseñar, construir o calcular el módulo de Flujo de Caja (Fase 1 del Blueprint TO-BE), o al interpretar el Flujo de Caja - Cash Flow / Control de Gastos actuales. No usar para otros módulos financieros."
